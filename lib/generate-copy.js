...
const copySchema = z.object({
  ...
  paragrafo_1: z
    .string()
    .describe(
      'Parágrafo principal, curto e direto (2-3 frases), texto corrido em português, sem formatação de nenhum ' +
        'tipo (sem markdown, sem asteriscos, sem aspas, sem listas). Escolha UM detalhe sensorial concreto — não ' +
        'tente encaixar tudo o que foi informado.'
    ),
  paragrafo_2: z
    .string()
    .describe(
      'Segundo parágrafo, também curto (2-3 frases), texto corrido, mesma regra de formatação do primeiro. Fala do ' +
        'dia a dia ou do entorno, sem repetir o que já foi dito. Sempre presente, nunca vazio.'
    ),
  specs_extra: z
    .array(
      z.object({
...
curto para a página do ${tipo}, focado no lado emocional: como vai ser a vida de quem mora ali —
não uma lista de qualidades do imóvel.
